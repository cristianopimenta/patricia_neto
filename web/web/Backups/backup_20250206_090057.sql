...
INSERT INTO `__efmigrationshistory` VALUES ('20250204202022_portaria', '8.0.12');
INSERT INTO `__efmigrationshistory` VALUES ('20250205010417_atualizaEmpresa', '8.0.12');
INSERT INTO `__efmigrationshistory` VALUES ('20250205011228_atualizaEmpresa1', '8.0.12');
INSERT INTO `__efmigrationshistory` VALUES ('20250205155333_EquipamentoCadastro', '8.0.12');
INSERT INTO `__efmigrationshistory` VALUES ('20250205160631_EquipamentoCadastro1', '8.0.12');
...
INSERT INTO `aspnetusers` VALUES ('fcfb470c-11ad-4e1b-9e68-c978173957b1', 'cristianopimenta@hotmail.com', 'CRISTIANOPIMENTA@HOTMAIL.COM', 'cristianopimenta@hotmail.com', 'CRISTIANOPIMENTA@HOTMAIL.COM', False, 'AQAAAAIAAYagAAAAEHmaSrN5FIb6zqtHdLxWnScbWckZee1Vn7hatRgOuwMZKxtojwZPNmBjAE2Ycq48+w==', 'M2WH2NVM7RE55FTHYJMTZPQFCBXHWKTC', '0b83efb7-3487-4a5e-b319-55d79587a7f0', '', False, False, NULL, True, 0);
...
INSERT INTO `empresas` VALUES (1, 'cristianopimenta@hotmail.com', 'OTIMIZE SISTEMAS', 'OTIMIZE SOLUÇÕES E SISTEMAS', 'OTMIZE SISTEMAS', '(62) 99862-2512', '50951688000163', '74230-325', 'rua verdi', '11', 'teste', 'europa', 'Goiania', 'GO', NULL, NULL, NULL, '08/08/2022 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '');
...
-- Estrutura da tabela `equipamentodestinos`
DROP TABLE IF EXISTS `equipamentodestinos`;
CREATE TABLE `equipamentodestinos` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `equipamentos` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `marcaEquipamento` int(11) NOT NULL,
  `NumeroMAC` longtext NOT NULL,
  `NomeEquipamento` longtext NOT NULL,
  `NumeroNotaFiscal` longtext NOT NULL,
  `DataCompra` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00.000000',
  `DataRegistro` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00.000000',
  `FornecedorId` int(11) DEFAULT NULL,
  `UsuarioId` longtext DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `IX_Equipamentos_FornecedorId` (`FornecedorId`),
  CONSTRAINT `FK_Equipamentos_Fornecedores_FornecedorId` FOREIGN KEY (`FornecedorId`) REFERENCES `fornecedores` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

INSERT INTO `equipamentos` VALUES (4, 1, '102030', 'Facial ControlID', '123456', '05/02/2025 00:00:00', '05/02/2025 14:15:24', 1, 'cristianopimenta@hotmail.com');
...
INSERT INTO `fornecedores` VALUES (1, 'OTIMIZE SISTEMAS', '50951253000163', 'rua verdi, 11', '62998622512', 'cristianopimenta@hotmail.com', 'TESTE 3');
...
CREATE TABLE `portarias` (
  ...
  `Nome` varchar(100) NOT NULL,
  `Descricao` longtext DEFAULT NULL,
  `UltimaAtualizacao` datetime(6) DEFAULT NULL,
  ...
  `UsuarioId` longtext DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `IX_Portarias_EmpresaId` (`EmpresaId`),
  CONSTRAINT `FK_Portarias_Empresas_EmpresaId` FOREIGN KEY (`EmpresaId`) REFERENCES `empresas` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

INSERT INTO `portarias` VALUES (1, 'Servico final 2', 'Serviço de temporarios entrada unica', '05/02/2025 11:12:48', 0, 1, 1, NULL, NULL, 'cristianopimenta@hotmail.com');
...
INSERT INTO `usuarios` VALUES (1, '', 'cristianopimenta@hotmail.com', '@25Pimenta', '', '', '');
